        ...
        <div className='footerall'>
            <div className='location'>
                ...
                <div className='SP'>
                    ...
                    <p><label>Vila Olimpoia - SP</label></p>
                    <p><label>+55 11 333 333</label></p>
                </div>
                ...
                <div className='button-position'>
                    <p>
                        <button className='btn'>
                            <img src={require('../../imagens/mail.png')} alt='mail' />
                        </button>
                    </p>
                    <p>
                        <button className='btn'>
                            ...
                            <div>FALE COM UM DOS NOSSOS CONSULTORES ONLINE</div>
                        </button>
                    </p>
                </div>
            </div>
            <div className='developer'>
                <img src={require('../../imagens/dev.png')} alt='developer' />
            </div>
        </div>
    </footer>  
);
